...
Astra Trident utiliza el controlador  `azure-netapp-files` para gestionar el servicio link:hhttps://azure.microsoft.com/en-us/products/netapp/["Azure NetApp Files"^].
